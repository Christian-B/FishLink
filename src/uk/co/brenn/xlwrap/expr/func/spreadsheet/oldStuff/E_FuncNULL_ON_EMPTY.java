 ...
 */
package uk.co.brenn.xlwrap.expr.func.spreadsheet.oldStuff;
 ...
 *
 */
public class E_FuncNULL_ON_EMPTY extends XLExprFunction {

	/**
	 * default constructor
	 */
	public E_FuncNULL_ON_EMPTY() {
	}

	/**
	 * single argument (a range)
	 */
	public E_FuncNULL_ON_EMPTY(XLExpr arg) {
		args.add(arg);
	}
