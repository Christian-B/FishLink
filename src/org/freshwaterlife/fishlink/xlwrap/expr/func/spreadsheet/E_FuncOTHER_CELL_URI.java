 ...
 *
 */
public class E_FuncOTHER_CELL_URI extends XLExprFunction {

	/**
	 * default constructor
	 */
	public E_FuncOTHER_CELL_URI() {
	}

	/**
	 * single argument (a range)
	 */
	public E_FuncOTHER_CELL_URI(XLExpr arg) {
		args.add(arg);
	}
	...
	public XLExprValue<String> eval(ExecutionContext context) throws XLWrapException, XLWrapEOFException {
        ...
        //Arg0 is the beging part of the URI
        XLExprValue<?> value0 = getArg(0).eval(context);
        String uriStart = value0.getValue().toString();

        //Arg1 is the cell reference to be used.
        ...
        //Ignore if referenced cell is empty
        XLExprValue<?> value1 = getArg(1).eval(context);
        if (value1 == null){
            return null;
        }

        //Arg2 is the cell that holds the data
        //Ignore if data cell is empty
        XLExprValue<?> value2 = getArg(1).eval(context);
        if (value2 == null){
            return null;
        }
